/*
  ...
  - Added the required column `network` to the `Trade` table without a default value. This is not possible if the table is not empty.
  - Added the required column `selectedCoin` to the `Trade` table without a default value. This is not possible if the table is not empty.
