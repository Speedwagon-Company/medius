...
INSERT INTO "new_Trade" ("canCallSupport", "channelId", "hideReciever", "hideSender", "id", "network", "received", "recieverId", "recieverStatus", "selectedCoin", "senderId", "senderStatus", "status") SELECT "canCallSupport", "channelId", "hideReciever", "hideSender", "id", "network", "received", "recieverId", "recieverStatus", "selectedCoin", "senderId", "senderStatus", "status" FROM "Trade";
DROP TABLE "Trade";
