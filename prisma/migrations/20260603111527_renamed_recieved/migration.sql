/*
  ...
  - You are about to drop the column `recieved` on the `Trade` table. All the data in the column will be lost.
...
INSERT INTO "new_Trade" ("canCallSupport", "channelId", "hideReciever", "hideSender", "id", "network", "recieverId", "recieverStatus", "selectedCoin", "senderId", "senderStatus", "status") SELECT "canCallSupport", "channelId", "hideReciever", "hideSender", "id", "network", "recieverId", "recieverStatus", "selectedCoin", "senderId", "senderStatus", "status" FROM "Trade";
DROP TABLE "Trade";
