/*
  ...
  - You are about to drop the column `canCallSupport` on the `Trade` table. All the data in the column will be lost.
...
INSERT INTO "new_Trade" ("channelId", "createdAt", "hideReciever", "hideSender", "id", "network", "received", "recieverId", "recieverStatus", "selectedCoin", "senderId", "senderStatus", "status") SELECT "channelId", "createdAt", "hideReciever", "hideSender", "id", "network", "received", "recieverId", "recieverStatus", "selectedCoin", "senderId", "senderStatus", "status" FROM "Trade";
DROP TABLE "Trade";
